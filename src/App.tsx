  ...
  return (
    <ErrorBoundary>
      ...
      <main className="flex-1 flex overflow-hidden relative">
        ...
        {/* Error Modal - Prominent Display */}
        {error && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="bg-red-900 border-2 border-red-500 rounded-2xl shadow-2xl max-w-md w-full p-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 bg-white text-red-900 font-semibold rounded-lg hover:bg-red-50 transition-colors"
                  >
                    Reload Page
                  </button>
                </div>
